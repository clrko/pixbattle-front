  ...
  return (
    <section className='CGU-background'>
      <div className='CGU-TextDecoration emails-container emails-container::-webkit-scrollbar-thumb '>
        ...
        <h6>Article 2 : Mentions légales</h6>
        <p>L’édition du site Pix Battle est assurée par la société Pix Battle inscrite au RCS sous le numéro ***, dont le siège social est localisé au *****.<br /> L’hébergeur du site PixBattle.com est la société OVH, sise au 19 Place Françoise Dorin, 75017 Paris, France.
        </p>
        <h6>Article 3 : Accès au site</h6>
        <p>Le site Pix Battle permet d’accéder gratuitement aux services suivants :</p>
        ...
        <p>Le site est accessible gratuitement depuis n’importe où par tout utilisateur disposant d’un accès à Internet.<br />
        ...
        <h6>Article 4 : Collecte des données</h6>
        <p>Pour la création du compte de l’Utilisateur, la collecte des informations au moment de l’inscription
          ...
          s’effectuent dans le respect de la vie privée.<br />
        ...
        <p>L’exercice de ce droit s’effectue par :</p>
        <ul className='listSet'>
          <li>Le formulaire de contact ;</li>
          <li>Son espace client.</li>
        </ul>
        <h6>Article 5 : Propriété intellectuelle</h6>
        <p>Les marques, logos ainsi que les contenus du site Pix Battle (illustrations graphiques, textes...) sont
          protégés par le Code de la propriété intellectuelle et par le droit d’auteur.<br />
        ...
        <p>Bien que les informations publiées sur le site soient réputées fiables, le site se réserve la faculté
          d’une non-garantie de la fiabilité des sources.<br />
          Les informations diffusées sur le site Pix Battle sont présentées à titre purement informatif et sont
          ...
          publication. Il en est de même pour l’utilisation et l’interprétation des informations communiquées
        ...
        <p>Le site peut être constitué de liens hypertextes. En cliquant sur ces derniers, l’Utilisateur sortira de la
          plateforme. Cette dernière n’a pas de contrôle et ne peut pas être tenue responsable du contenu des pages web relatives à ces liens.
        </p>
        ...
        <p>Lors des visites sur le site, l’installation automatique d’un cookie sur le logiciel de navigation de
          l’Utilisateur peut survenir.<br />
          Les cookies correspondent à de petits fichiers déposés temporairement sur le disque dur de
          l’ordinateur de l’Utilisateur. Ces cookies sont nécessaires pour assurer l’accessibilité et la navigation
          sur le site. Ces fichiers ne comportent pas d’informations personnelles et ne peuvent pas être utilisés pour l’identification d’une personne.<br />
          L’information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site Pix Battle.fr.<br />
        ...
        <h6>Article 9 : Publication par l’Utilisateur</h6>
        <p>Le site Pix Battle permet aux membres de publier des commentaires et des photographies.<br />
          Dans ses publications, commentaires ou photographie, le membre est tenu de respecter les règles de
          la Netiquette ainsi que les règles de droit en vigueur.<br />
          Le site dispose du droit d’exercer une modération à priori sur les publications et peut refuser leur
          mise en ligne sans avoir à fournir de justification.<br />
          ...
          sur le web et sur les réseaux de téléphonie mobile.<br />
        ...
        <h6>Article 11 : Durée du contrat</h6>
        ...
        <h6>Article 12 : Droit applicable et juridiction compétente</h6>
